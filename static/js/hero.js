(function () {
  ...
  function drawCertificate(callback) {
    ...
    img.onload = function () {
      ...
      ctx.fillText('شهادة شكر وتقدير', centerX, 360);
      ctx.fillStyle = '#D4AF37';
      ctx.font = 'bold 76px Tahoma, Arial';
      ctx.fillText('بطل الصحة في عسير', centerX, 455);
      ctx.fillStyle = '#4B5563';
      ctx.font = '32px Tahoma, Arial';
      ctx.fillText('تمنح هذه الشهادة إلى', centerX, 535);
      ctx.fillStyle = '#0F172A';
      ctx.font = 'bold 72px Tahoma, Arial';
      ctx.fillText(name, centerX, 630);
      ctx.fillStyle = '#334155';
      ctx.font = '31px Tahoma, Arial';
      ctx.fillText(`تقديرًا لمشاركته في تحدي بطل الصحة وتحقيقه ${score} من ${total} نقطة`, centerX, 705);
      ctx.fillStyle = '#15508A';
      ctx.font = 'bold 34px Tahoma, Arial';
      ctx.fillText(badge, centerX, 765);
      ctx.fillStyle = '#64748B';
      ctx.font = '26px Tahoma, Arial';
      ctx.fillText(date, centerX, 840);
      callback(canvas);
    };
